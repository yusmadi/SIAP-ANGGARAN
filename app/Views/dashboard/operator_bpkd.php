                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-white text-primary px-3 py-1.5 fs-6 rounded-pill fw-bold">
                                <i class="bi bi-headset me-1"></i> <?= esc($user['role_name']) ?>
                            </span>
                            <span class="badge bg-white bg-opacity-20 text-white px-3 py-1.5 fs-6 rounded-pill">
                                Tim Entri Operasional & Input Data BPKD
                            </span>
                        </div>

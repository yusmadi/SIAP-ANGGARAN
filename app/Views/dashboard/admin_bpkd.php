                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <span class="badge bg-info text-dark px-3 py-1.5 fs-6 rounded-pill fw-bold" style="background-color: #06b6d4;">
                                <i class="bi bi-gear-wide-connected me-1"></i> <?= esc($user['role_name']) ?>
                            </span>
                            <span class="badge bg-white bg-opacity-20 text-white px-3 py-1.5 fs-6 rounded-pill">
                                Pengelola Teknis & Master Data
                            </span>
                        </div>
